          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="#Registros" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-plus"></i>Registros </a>
              <ul id="Registros" class="collapse list-unstyled ">
                <li><a href="../view/index.php?talent=2">Tecnologías</a></li>
                <li><a href="../view/index.php?talent=3">Niveles</a></li>
                <li><a href="../view/index.php?talent=4">Categorias</a></li>
                <h5 class="sidenav-heading">Escuelas</h5>                
                <li><a href="../view/index.php?talent=5">Institución</a></li>
                <li><a href="../view/index.php?talent=6">Proyectos</a></li>
              </ul>
            </li>
        ...
        <div class="container-fluid">
         <div class="right_col" role="main" >
          ...
          <?php
              ...
              if ($enrutador->validarGET($_GET['talent'])) { 
                    $enrutador->cargarVista($_GET['talent']);
                 }else{
